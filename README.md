...
5) Try to ping the default gateway, if you can, then check if you can ping a host on another subnet. If you can ping the Pfsense's Interface on another subnet, but cant ping any machines on that subnet then it might be a host firewall issue.
